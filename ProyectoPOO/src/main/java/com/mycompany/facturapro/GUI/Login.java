...
public class Login extends javax.swing.JFrame {
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        ...
        char[] contraseña = "*****".toCharArray();
        
        if(username.getText().equals("admin")&& Arrays.equals(password.getPassword(), contraseña)){
            Menu menu = new Menu();
            menu.setVisible(true);
            menu.setLocationRelativeTo(null);
            dispose();
        } else {
            JOptionPane.showMessageDialog(null, "Los datos ingresados son inválidos, intente nuevamente");
        }
