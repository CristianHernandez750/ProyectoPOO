...
import com.mycompany.facturapro.database.BillsDB;
...
import com.mycompany.facturapro.database.Session;
...
public class BillScreen extends javax.swing.JFrame {
    ...
    private void btnBuscarFacturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarFacturaActionPerformed
        ...
        /*Bill factura = facturas.stream()
                ...
                .orElse(null);
         */
        bill.buscarFactura(nombre, fieldSeller, fieldClient, fieldDate);
        /*if (factura == null) {
    ...
    private void btnInventarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInventarioActionPerformed
        ...
        product.mostrarInventario();
    }//GEN-LAST:event_btnInventarioActionPerformed

    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        String element = txtProduct.getText().trim();
        ProductsDB product = new ProductsDB();
        Product producto = product.buscarProducto(element);
    ...
    private void btnGenerarFacturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarFacturaActionPerformed
        ...
        Person cliente = customer.buscarCliente(nombre);
        if (productosFacturar.size() <= 0) {
            JOptionPane.showMessageDialog(null, "Debe ingresar productos para poder facturar");
        } else {
            if (cliente != null) {
                seller = new NaturalPerson(Session.sellerName, 12345);
                boolean result = bill.generarFactura(seller.getNombre(), nombre, totalPrice);
                if (result) {
